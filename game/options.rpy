...
define build.directory_name = _("ArisizationProject") 
...
define config.version = "Version_0.0.5" 
...
define build.name = "Arisization-Project"
...
init python: 
    ...
    build.classify("game/**.rpym", "script") 
    build.classify("game/**.json", "script") 
